...
const BodyHomePage = ()=>{
    ...
    const callAPi = ()=>{
        fetch(`https://api.clarifai.com/v2/models/${MODEL_ID}/versions/${MODEL_VERSION}/outputs`, requestOptions).then((response)=>response.text()
        ).then((result)=>console.log(result)
        ).catch((error)=>console.log("error", error)
        );
    };
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "flex flex-col xl:flex-row lg:flex-row bg-opacity-60 bg-clip-padding backdrop-blur-3xl bg-transparent xl:w-2/5 lg:h-1/4 lg:w-3/5 h-1/4 w-5/6 !justify-center items-center",
        children: [
...
const RankDescription = (props)=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "flex flex-col text-white justify-start items-center",
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("p", {
                        className: "text-white mb-5 text-xl",
                        children: "This Magic brain will detect faces in your pictures. Fit it a try."
                    }),
